        ...
        <div class="mb-4 flex justify-between">
            ...
            <div class="flex gap-2 items-center">
                ...
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button" @class(['btn m-1 btn-sm font-bold', 'bg-primary' => $roleFilter !== '-1' || $statusFilter !== '-1',])>
            ...
            <table class="table table-zebra">
                ...
                <thead>
                    <tr>
                        <th>#</th>
                        <th>
                            <button @class(['text-accent' => $orderBy == 'username', 'hover:underline cursor-pointer hover:text-accent flex items-center']) wire:click="toggleOrder('username')">USERNAME
                        ...
                        <th>
                            <button @class(['text-accent' => $orderBy == 'employee.lastname', 'hover:underline cursor-pointer hover:text-accent']) wire:click="toggleOrder('employee.lastname')">NAME
                        ...
                        <th>
                            <button @class(['text-accent' => $orderBy == 'created_at', 'hover:underline cursor-pointer hover:text-accent']) wire:click="toggleOrder('created_at')">CREATED AT
                        ...
                        <th>
                            <button @class(['text-accent' => $orderBy == 'updated_at', 'hover:underline cursor-pointer hover:text-accent']) wire:click="toggleOrder('updated_at')">UPDATED AT
