<div class="h-full flex flex-col">
    ...
    <div wire:init="fetchEmployees()"
        class="bg-base-100 border-2 border-neutral/25 rounded-md p-4 shadow-md grow overflow-hidden">
        <div class="flex flex-col items-center gap-2 overflow-x-auto h-full">
                        ...
                        <div x-show="open" class="dropdown dropdown-open">
                            ...
                            <div tabindex="0"
                                ...
                                <div class="h-full overflow-y-auto">
                                    <div wire:loading
                                        class="p-2 flex items-center justify-center w-full overflow-y-hidden">
