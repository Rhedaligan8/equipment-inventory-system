<div class="h-full flex flex-col">
    ...
    <button x-on:click="activeTab = 'addLocation'" class="btn btn-sm btn-primary text-base-100 self-end mb-2">
                            ...
                            <tbody>
                                @foreach ($locations as $location)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <button wire:click="setLocationId({{ $location->location_id }})"
                                                x-on:click="activeTab = 'editLocation'" class="btn btn-ghost">
