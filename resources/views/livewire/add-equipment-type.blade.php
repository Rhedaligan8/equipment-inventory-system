<div class="h-full flex flex-col">
    <button x-on:click="activeTab = 'equipmentTypesTable'" class="btn btn-sm btn-primary text-base-100 self-start mb-2">
        <i class="bi bi-arrow-left-short"></i>
        GO BACK</button>
    <div class="bg-base-100 border-2 border-neutral/25 rounded-md p-4 shadow-md grow overflow-hidden">
        <div class="overflow-x-auto h-full">

            <h3 class="text-xl font-bold font-inter my-2">ADD EQUIPMENT TYPE</h3>
            <!-- inputs -->
